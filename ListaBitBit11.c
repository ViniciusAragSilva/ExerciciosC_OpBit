/*
EXERCICIOS DE MANIPULAÇÂO DE BITS 11 - Vinicius Aragão 4323
-------------------------------------------------------------------
  Solicite um valor para a variável x. 
  Calcule o complemento-1 deste valor
  (complemento-1 é o que falta pro numero atingir 10000000)
*/
