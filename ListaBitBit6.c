/*
EXERCICIOS DE MANIPULAÇÂO DE BITS 6 - Vinicius Aragão 4323
-------------------------------------------------------------------
  Solicite um valor para a variável x e um índice b
   que indica um dos bits da variável. 
   Mantenha o valor daquele bit, zere os demais. 
...
void main(void)
{
 ...
 printf("e outro também, que será o endereço do byte (0 a 7)\n");
  printf("o número do endereço será o único mantido no valor de acordo com o número digitado\n\n");
